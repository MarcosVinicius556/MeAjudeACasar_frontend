                    ...
                    return (
                        <tr key={index}>
                          ...
                          <td className="action-column" data-label="">
                            <button className="action" onClick={(e) => toggleModal(gift)} style={{ backgroundColor: '#3c7ee0' }}>
                              Detalhes 
                            </button>
                            {user.role === "ADMIN" && 
                              <Link to={`/gifts/new/${gift.id}`} onClick={() => toggleModal(gift)} className="action" style={{ backgroundColor: '#f3bb68' }}>
                                Editar 
                              </Link>
                            }
                          </td>
